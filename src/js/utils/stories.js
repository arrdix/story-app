  ...
  function renderCard(stories) {
    stories.forEach((story, index) => {
      ...
      carouselItem.setAttribute(
        'class',
        `carousel-item adaptive-rounded-5 h-100 ${isFirstIndex ? ' active' : ''}`,
      );
      ...
      carouselItem.innerHTML = `
        <div class="card h-100 text-light">
          <img src="${
            story.photoUrl
          }" class="card-img h-100 object-fit-cover p-0" alt="Story Image">
          ...
          <div class="card-img-overlay">
            <div class="card-title d-flex justify-content-between align-items-center ps-2 pt-2">
              <div class="d-flex flex-row gap-2">
                <img src="${
                  isOwner ? '/julia-garner.jpg' : story.photoUrl
                }" class="stories-dp object-fit-cover rounded-circle border border-3 border-light" alt="">
              ...
              <div class="fs-6 px-3">
                <button class="btn btn-detail text-light p-0 z-3" id="${
                  story.id
                }" type="button" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Show detail">
