    ...
    return html`
      ...
      <div class="col-9 text-dark d-flex flex-row justify-content-between mb-2 pb-2 px-5">
        <div class="d-flex justify-content-around align-items-center gap-5">
          <a
            class="link-dark link-underline link-underline-opacity-0 link-opacity-75-hover fs-8 pop-button"
            href="/"
            type="button"
            >${msg('Home')}</a
          >
              ...
              (locale) => html`
                <li>
                  <a
                    ...
                    class="dropdown-item fs-10"
                    type="button"
                    aria-label="${locale}"
                    href="#"
                    >${localeNames[locale]} (${locale.toUpperCase()})</a
                  >
                </li>
              `,
            )}
